...
(def v-table-args-desc
  [{:name :model                      :required true                 :type "vector of maps | atom"    :validate-fn vector-or-atom?      :description "one element for each row in the table."}
   ...
   {:name :column-header-height       :required false                :type "integer"                  :validate-fn number?              :description "px height of the column header. Impacts sections 1, 4 and 7."}
   {:name :column-footer-height       :required false                :type "integer"                  :validate-fn number?              :description "px height of the column footer. Impacts sections 3, 6 and 9."}
   {:name :row-content-width          :required true                 :type "integer"                  :validate-fn? number?             :description "px width of section 5"}
   ...
   {:name :top-left-renderer          :required false                :type "-> hiccup"                :validate-fn fn?                  :description "This function returns the hiccup for the top left section (section 1)."}
   {:name :row-header-renderer        :required false                :type "row -> hiccup"            :validate-fn fn?                  :description "This function returns the hiccup for the row header (section 2)."}
   {:name :bottom-left-renderer       :required false                :type "-> nil"                   :validate-fn fn?                  :description "This function returns the hiccup for the bottom left section (section 3)."}
   {:name :column-header-renderer     :required false                :type "-> hiccup"                :validate-fn fn?                  :description "This function returns the hiccup for the entire column header (section 4)."}
   {:name :row-renderer               :required true                 :type "row-index, row -> hiccup" :validate-fn fn?                  :description "This function returns the hiccup for a single content row (section 5)."}
   {:name :column-footer-renderer     :required false                :type "-> hiccup"                :validate-fn? fn?                 :description "This function returns the hiccup for the entire column footer (section 6)."}
   {:name :top-right-renderer         :required false                :type "-> hiccup"                :validate-fn fn?                  :description "This function returns the hiccup for the top right (section 7)."}
   {:name :row-footer-renderer        :required false                :type "row -> hiccup"            :validate-fn fn?                  :description "This function returns the hiccup for the row footer (section 8)."}
   {:name :bottom-right-renderer      :required false                :type "-> hiccup"                :validate-fn fn?                  :description "This function returns the hiccup for the bottom right (section 9)."}
