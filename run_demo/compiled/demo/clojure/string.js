...
{{
var G__13294 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13294;
continue;
}
} else
...
{var pred__13298 = cljs.core._EQ_;var expr__13299 = limit;if(cljs.core.truth_(pred__13298.call(null,(1),expr__13299)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13298.call(null,(2),expr__13299)))
...
var G__13301 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13302 = (limit__$1 - (1));
var G__13303 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__13301;
limit__$1 = G__13302;
parts = G__13303;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___13305 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___13305))
{var replacement_13306 = temp__4124__auto___13305;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_13306)));
} else
{buffer.append(ch);
}
{
var G__13307 = (index + (1));
index = G__13307;
continue;
}
}
